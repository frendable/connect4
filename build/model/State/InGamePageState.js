...
var InGamePageState = function (_PageState) {
  ...
  function InGamePageState() {
    _classCallCheck(this, InGamePageState);

    return _possibleConstructorReturn(this, (InGamePageState.__proto__ || Object.getPrototypeOf(InGamePageState)).call(this, _GameConstant.PAGE.IN_GAME));
  }
  ...
  return InGamePageState;
}(_PageState3.default);

exports.default = InGamePageState;
